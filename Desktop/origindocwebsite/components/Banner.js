...
const Banner = () => {
  return (
    <div className="bg-primeColor w-full rounded-b-3xl relative px-4">
      <Container>
        <div className="text-white grid md:grid-cols-2 gap-20 place-items-center p-10">
          {/* leftSide */}
          <div className="flex flex-col gap-6">
            ...
            <FadeIn>
              <p className="text-sm tracking-wider xl:gap-10">
                煩わしいレポート作成作業にさよならを告げませんか？「レポートアプリ」
                があなたの仕事を劇的に効率化します!
                <br />
                高度な技術やデザインスキルが不要。直感的なインターフェース
                で、わずか数分でプロフェッショナルなレポートを作成できます。
                <br />
                事前に設計されたテンプレートを使用して、さまざまな種類の
                レポートを簡単に作成できます。売上分析、プレゼンテーション、
                プロジェクト進捗など、あらゆる用途に対応しています。
              </p>
            </FadeIn>
              ...
              >
                <input
                  ...
                  className="w-full 
                            ...
                            duration-300
                            focus-visible:border-primeColor"
                />
                <button
                  className="w-full 
                                h-12 
